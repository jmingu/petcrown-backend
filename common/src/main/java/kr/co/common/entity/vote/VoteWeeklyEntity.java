...
@Getter
public class VoteWeeklyEntity {
    private Long voteWeeklyId; // 기본 PK
    ...
    // 생성용
    public VoteWeeklyEntity(Long createUserId, Long updateUserId, LocalDate weekStartDate, Long petId, int voteCount, int viewCount, int modeId) {
